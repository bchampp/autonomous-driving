...
if("TRUE" STREQUAL "TRUE")
  set(opencv_tests_SOURCE_PREFIX /home/nvidia/ros1/src/vision_opencv/opencv_tests)
  set(opencv_tests_DEVEL_PREFIX /home/nvidia/ros1/devel)
  ...
  set(opencv_tests_INSTALL_PREFIX /home/nvidia/ros1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/ros1/src/vision_opencv/opencv_tests/${idir}'.  ${_report}")
    endif()
