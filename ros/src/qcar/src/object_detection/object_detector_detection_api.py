...
PATH_TO_LABELS = path.join(basepath, 'model', 'mscoco_label_map.pbtxt')
PATH_TO_MODEL = path.join(basepath, 'model', 'object_detection.pb')
...
class ObjectDetectorDetectionAPI(ObjectDetector):
    def __init__(self, graph_path=PATH_TO_MODEL):
        """
