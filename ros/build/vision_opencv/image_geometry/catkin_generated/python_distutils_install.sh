...
echo_and_run cd "/home/nvidia/ros1/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/nvidia/ros1/src/vision_opencv/image_geometry/setup.py" \
     \
    build --build-base "/home/nvidia/ros1/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
